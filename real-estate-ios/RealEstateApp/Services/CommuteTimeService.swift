...
final class CommuteTimeService {
    ...
    /// オフィスA（〒102-0082 千代田区（勤務地））
    static let playgroundCoordinate = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
    static let playgroundName = "オフィスA"

    /// オフィスB株式会社（〒105-0001 港区虎ノ門4丁目1-28）
    static let m3careerCoordinate = CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
