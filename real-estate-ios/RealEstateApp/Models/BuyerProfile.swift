...
struct BuyerProfile: Codable, Equatable {
    ...
    static let preset = BuyerProfile(
        ...
        selfFunds: "なし（フルローン）",
        plannedBorrowing: "諸費用(物件価格の約6%)+物件価格全額。FP相談で与信最大額までの借入も理論上問題なしと確認。試算例は11,800万円・50年・変動1.3%・頭金なし（月返済26.94万円）。",
        interestType: .variable,
        estimatedRate: "1.3%（FPライフプラン設計時の前提金利）",
        repaymentYears: "50年",
        monthlyPaymentLimit: "FP相談で与信枠最大までの借入が破綻しないと確認済み。制約は①与信枠 ②産休育休期間のキャッシュフロー成立性。試算例は月総額約32万円（管理修繕固定資産税込み）。",
