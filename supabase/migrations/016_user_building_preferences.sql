-- Nope/Like: building-level preference (normalized_name ベース)

CREATE TABLE IF NOT EXISTS user_building_preferences (
...
-- listings_feed ビューを再作成して normalized_name を含める
...
-- get_listings_since を再作成（CASCADE で消えたため）
