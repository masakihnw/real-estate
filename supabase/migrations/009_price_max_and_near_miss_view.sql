-- Add price_max_man to listing_sources (新築物件の価格上限)
-- Add near_miss/near_miss_reasons to listings_feed view

ALTER TABLE listing_sources
    ADD COLUMN IF NOT EXISTS price_max_man INTEGER;

-- Rebuild view with price_max_man + near_miss fields
