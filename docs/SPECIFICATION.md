...
| 14 | テンプレート保存 | テンプレートメニュー → 「現在の条件を保存…」 | 現在のフィルタ条件に名前を付けて保存（最大5件。フィルタ未設定時・上限到達時は無効） |
| 15 | テンプレート適用 | テンプレートメニュー → テンプレート名タップ | 保存済みテンプレートのフィルタ条件を即座に反映 |
| 16 | テンプレートリネーム | テンプレートメニュー → 「名前を変更…」 → テンプレート選択 | テンプレート名を変更 |
| 17 | テンプレート削除 | テンプレートメニュー → 「削除…」 → テンプレート選択 | テンプレートを個別に削除 |
